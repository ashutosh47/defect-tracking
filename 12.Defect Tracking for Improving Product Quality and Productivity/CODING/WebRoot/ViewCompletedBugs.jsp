...
<%
  ...
  report=report+"<caption>VIEW COMPLETED BUGS</caption>";
  report=report+"<tr><th bgcolor=lightgreen><b>BugId</b></th><th bgcolor=lightgreen><b>BugName</b></th><th bgcolor=lightgreen><b>RaisedDate</b></th><th bgcolor=lightgreen><b>Priority</b></th><th bgcolor=lightgreen><b>Status</b></th></tr>";
	  ...
	  <p>&nbsp;</p>
        ...
        %>
            ...
            bugid = aBug.getBugID(); 
            			        ...
            			        report=report+"<tr><td>"+bugid+"</td>";
    report=report+"<td>"+aBug.getBugName()+"</td>";
   report=report+"<td>"+DateWrapper.parseDate(aBug.getRaisedDate1())+"</td>";
   report=report+"<td>"+((Bug)pCoreHash.get(new Integer(aBug.getPriorityID()))).getPriorityName()+"</td>";
  report=report+"<td>"+aBug.getStatus()+"</td></tr>";
