...
<%
  ...
  report=report+"<caption>MEMBER RECORD INFORMATION</caption>";
  
  report=report+"<tr><th bgcolor=lightgreen><b>LoginName</b></th><th bgcolor=lightgreen><b>MEMBERName</b></th><th bgcolor=lightgreen><b>ROLE</b></th><th bgcolor=lightgreen><b>Email</b></th><th bgcolor=lightgreen><b>Phno</b></th></tr>";
...
<div id="latest-post" class="wide-post">
        ...
        <td width="144"><div align="center" class="style2 style8"><strong>Contact No</strong></div></td>
          ...
          <%
			 ...
			 while(enu.hasMoreElements())
			 {
			        ...
			        report=report+"<tr><td>"+loginname+"</td>";
    report=report+"<td>"+profile.getFirstName()+" "+profile.getLastName()+"</td>";
   report=report+"<td>"+profile.getRole()+"</td>";
   report=report+"<td>"+profile.getEmail()+"</td>";
  report=report+"<td>"+profile.getPhoneNo()+"</td></tr>";
 ...
 %> 
        ...
        <td bgcolor="#C3D7BA"><div align="center"><span class="style7"><%=(profile.getEmail())%></span></div></td>
