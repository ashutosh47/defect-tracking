	...
	<div class="entry">
	  <p>&nbsp;</p>
        ...
        <tr>
                  ...
                  <tr>
                     <td height="25"><span class="style2">Project Name</span></td>
                     <td>
                       <select name="projectid" id="projectid">
                      <%
                         		Project project = new Project();
                                              
             					CoreHash dCoreHash1 = new ProjectsDAO().getProject((String)session.getAttribute("user"));
             					session.setAttribute("project",dCoreHash1);
             					Enumeration enu1 = dCoreHash1.elements();
             					while(enu1.hasMoreElements())
             					{
             					   project = (Project)enu1.nextElement();
