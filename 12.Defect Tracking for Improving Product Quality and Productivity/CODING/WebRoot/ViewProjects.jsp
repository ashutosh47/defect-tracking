...
<%
  ...
  report=report+"<caption>PROJECT RECORD INFORMATION</caption>";
  
  report=report+"<tr><th bgcolor=lightgreen><b>SNO</b></th><th bgcolor=lightgreen><b>Project Name</b></th><th bgcolor=lightgreen><b>Start Date</b></th><th bgcolor=lightgreen><b>End Date</b></th><th bgcolor=lightgreen><b>Status</b></th></tr>";
        ...
        %>
          	...
          	Enumeration enu = dCoreHash.elements();
          			...
          			while (enu.hasMoreElements()) {
          				...
          				report=report+"<tr><td>"+projectid+"</td>";
    report=report+"<td>"+aProject.getProjectName()+"</td>";
   report=report+"<td>"+DateWrapper.parseDate(aProject.getStartDate1())+"</td>";
   report=report+"<td>"+DateWrapper.parseDate(aProject.getEndDate1())+"</td>";
  report=report+"<td>"+aProject.getStatus()+"</td></tr>";
